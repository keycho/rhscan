  ...
  return (
    <section className="mx-auto max-w-page px-4 pt-8">
      ...
      <div className="grid grid-cols-2 gap-2.5 sm:grid-cols-4 xl:grid-cols-8">
        ...
        <MetricCard label="tokens routed" value={1.2} suffix="M" decimals={1} icon={Coins} sub="$POF routed to date" />
        <MetricCard label="burned supply" value={0.31} suffix="M" decimals={2} icon={Flame} sub="perma-locked" subTone="amber" />
